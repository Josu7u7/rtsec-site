...
const services = [
...

  {
    ...
    items: [
      ...
      "Configuración segura e integración con plataformas",
      "Pruebas de disponibilidad y validación operativa",
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="services-detail-block-copy">
                ...
                <h2 className="services-detail-block-title">
                  {service.title}
                </h2>

                <p className="services-detail-block-intro">
                  {service.intro}
                </p>
